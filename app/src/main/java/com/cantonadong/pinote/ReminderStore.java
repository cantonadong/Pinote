...
final class ReminderStore{
 ...
 static final class Reminder{long id,updated;String title,type,text;boolean pinned,alert;ArrayList<Todo> todos=new ArrayList<>();Reminder(long i){id=i;updated=System.currentTimeMillis();title="";type="todo";text="";}}
